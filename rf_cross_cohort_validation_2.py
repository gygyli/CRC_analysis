# rf_cross_cohort_validation_2.py
# Author: Guangyi Li
# Date: 2025-06-17
# Description: Perform cross-cohort external validation of Random Forest models from different countries; evaluate multiple metrics, and save results grouped by taxonomy level.
