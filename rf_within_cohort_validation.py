# rf_within_cohort_validation.py
# Author: Guangyi Li
# Date: 2025-06-17
# Description: Perform within-cohort validation of Random Forest models with feature selection and hyperparameter tuning on microbial data, evaluating and saving performance metrics.
